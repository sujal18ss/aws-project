function create(){
    ...
    if(decision == true){
         ...
         xhr.open('GET','http://15.206.116.52/cgi-bin/create.py?i=' +img+ '&n=' +cname,true);
        //  http://15.207.254.199/cgi-bin/create.py?i
         xhr.send();
         xhr.onload=function (){
...
function del(){
    ...
    if(decision == true){
            ...
            xhr = new XMLHttpRequest();
            xhr.open('GET','http://15.206.116.52/cgi-bin/del.py?n= '+cname,true);
...
xhr.open('GET', 'http://15.206.116.52/cgi-bin/run.py?x='+i,true);
// http://15.207.254.199/cgi-bin/run.py?x
xhr.send();
xhr.onload=function(){
